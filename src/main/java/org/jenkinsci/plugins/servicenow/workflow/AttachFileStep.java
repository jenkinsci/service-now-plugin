...
public class AttachFileStep extends AbstractServiceNowStep {
    ...
    public AttachFileStep(ServiceNowConfiguration serviceNowConfiguration, String credentialsId, ServiceNowItem serviceNowItem) {
    ...
    public static final class Execution extends AbstractItemProviderExecution<ResponseContentSupplier> {
        ...
        Execution(@Nonnull StepContext context, @Nonnull AttachFileStep step) {
            super(context);
            this.step = step;
        }
